...
// 상품 목록 부분은 해당 디비 서버에 연결이 되어서 , 불러오게 연동이 되었다면. 
	...
	public ProductRepository() {
		...
		Product phone = new Product("P1234", "iPhone 6s+", 800001);
		...
		// 회사 이름 : test
		/*
		 * Product testLarva2 = new Product("P123456", "test", 1000);
		 * testLarva2.setDescription("test1"); testLarva2.setCategory("test1");
		 * testLarva2.setManufacturer("test1"); testLarva2.setUnitsInStock(10);
		 * testLarva2.setCondition("New"); testLarva2.setFilename("라바1.jfif");
		 */
